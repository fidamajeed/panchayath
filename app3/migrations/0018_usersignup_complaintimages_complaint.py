# Generated by Django 5.0.3 on 2024-03-23 05:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app3', '0017_delete_complaint_delete_usersignup'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('panchayat', models.CharField(choices=[('Puthenvelikkara', 'Puthenvelikkara'), ('Chengamanadu', 'Chengamanadu'), ('Nedumbassery', 'Nedumbassery'), ('Parakkadavu', 'Parakkadavu'), ('Kunnukara', 'Kunnukara')], default='Nedumbassery', max_length=100)),
